...
The exact text is data-dependent, but the Components V2 message is intentionally organized as one compact control center:
...
When twoWhit is currently live, a dedicated **🔴 LIVE** section with a Watch Live link is inserted near the top.
